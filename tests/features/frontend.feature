Feature: Vörðu Frontend
    ...
    @vordu:project=vordu @vordu:row=vordu-web @vordu:phase=0
    ...
    @vordu:project=vordu @vordu:row=vordu-web @vordu:phase=1
    ...
    @vordu:project=vordu @vordu:row=vordu-web @vordu:phase=2 @wip
    ...
    @vordu:project=vordu @vordu:row=vordu-web @vordu:phase=3 @wip
